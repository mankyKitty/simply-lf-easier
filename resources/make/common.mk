...
ERL_LIBS=.:..:../simply-lf-easier:$(shell $(LFETOOL) info erllibs)
OS := $(shell uname -s)
ifeq ($(OS),Linux)
        HOST=$(HOSTNAME)
endif
...
get-version:
	...
	-eval "lfe_io:format(\"~p~n\",['simply-lf-easier-util':'get-versions'()])." \
...
install: compile
	@echo "Installing simply-lf-easier ..."
	@PATH=$(SCRIPT_PATH) lfetool install lfe

upload: $(EXPM) get-version
	@echo "Preparing to upload simply-lf-easier ..."
	@echo
	@echo "Package file:"
	@echo
	@cat package.exs
